...
class Tool {
     ...
     * @return bool
     */
    public static function uploadSmallImage($fileName,$save_path){
        ...
        imagefilledrectangle($thumb,0,0,$height,$height,$white);
        //1 = GIF，2 = JPG，3 = PNG
        switch ($type){
            case 1:
    ...
    public static function virefyCode($length,$width,$height,$channel){
